...
MODEL_ORDER = {
    ...
    ('erp_notifications', 'NotificationBatch'): 20,
    ('erp_notifications', 'NotificationTemplate'): 30,
    ('erp_notifications', 'NotificationLog'): 40,
    ('erp_notifications', 'DeviceToken'): 50,
...
MODEL_VERBOSE_NAMES = {
    ...
    ('crm', 'ClientQuestionnaire'): ('Анкета клиента', 'Анкеты клиентов'),
    ...
    ('erp_notifications', 'NotificationBatch'): ('Рассылка уведомлений', 'Рассылки уведомлений'),
