...
from .views import LeadCreateAPIView, LeadViewSet, MobileChatAttachmentUploadAPIView, MobileClientDocumentSyncAPIView, MobileClientDocumentUploadAPIView, MobileClientQuestionnaireSyncAPIView, MobileClientSyncAPIView
...
urlpatterns = [
    ...
    path('mobile/chat/upload/', MobileChatAttachmentUploadAPIView.as_view(), name='mobile-chat-upload'),
