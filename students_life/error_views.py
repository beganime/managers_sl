...
ERROR_COPY = {
    ...
    500: {
        ...
        'description': 'Проверьте, сохранилось ли действие, прежде чем отправлять форму повторно. Если ошибка повторится, сообщите администратору время и название страницы.',
        'icon': 'server-crash',
    },
}
