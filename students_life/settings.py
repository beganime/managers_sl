...
INSTALLED_APPS = [
    ...
    'timetracking',
    'reports',
    'mailing',          # ← новое приложение рассылки
]
...
DATABASES = {
    'default': {
        ...
        'NAME':     os.environ.get('DB_NAME',     'SL_db'),
...
PWA_APP_ICONS_APPLE   = [{'src': '/static/logo.ico', 'sizes': '160x160', 'type': 'image/png'}]
...
UNFOLD = {
    ...
    "COLORS": {
        "primary": {
            ...
            "600": "229 57 53",   "700": "211 47 47",   "800": "198 40 40",
            "900": "183 28 28",
        },
        "secondary": {
