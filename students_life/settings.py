...
ATTENDANCE_REPORT_REMINDER_MINUTE = int(os.environ.get('ATTENDANCE_REPORT_REMINDER_MINUTE', '30'))
ATTENDANCE_CLOSE_REMINDER_HOUR = int(os.environ.get('ATTENDANCE_CLOSE_REMINDER_HOUR', '18'))
ATTENDANCE_CLOSE_REMINDER_MINUTE = int(os.environ.get('ATTENDANCE_CLOSE_REMINDER_MINUTE', '0'))
ATTENDANCE_WORKDAYS = tuple(
    int(value.strip())
    for value in os.environ.get('ATTENDANCE_WORKDAYS', '0,1,2,3,4,5').split(',')
    if value.strip()
)
ATTENDANCE_TELEGRAM_ENABLED = env_bool('ATTENDANCE_TELEGRAM_ENABLED', False)
ATTENDANCE_TELEGRAM_BOT_TOKEN = os.environ.get('ATTENDANCE_TELEGRAM_BOT_TOKEN', '')
